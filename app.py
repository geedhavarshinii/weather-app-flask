#make a virtual env and install all the modules needed
...
def index():
    if requests.method == 'POST':
        ...
        #take some attributes like temperature, humidity, pressur of this
        temperature = int(json_object['main']['temp']-273.15) #this temperature in kelvin
        humidity = int(json_object['main']['humidity'])
        pressure = int(json_object['main']['pressure'])
        wind = int(json_object['wind']['speed'])

        #finally just pass the variables
